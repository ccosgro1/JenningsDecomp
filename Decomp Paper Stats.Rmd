...
#decompk.allspec.col=data.frame(ncol=68, ncol=5)
#decompk.allspec.col=cbind(decay.k.data.acesac,decay.k.data.carova,decay.k.data.querub)
#decompk.allspec.col
```

```{r stats}
# ANOVA analysis
mass.k.anova=lme(as.numeric(as.matrix(decompk))~Species*Treatment*Tree, random=~1|fullBlock, data=decompk.allspec)
anova(mass.k.anova)
