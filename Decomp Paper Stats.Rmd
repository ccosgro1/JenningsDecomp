...
decompk.row.ripup$Species=factor(decompk.row.ripup$Species, levels=c("ACESAC","CAROVA","QUERUB"))
#plot. Gotta think about the best way to display these data.
...
ggplot(decompk.row.ripup, aes(x=Species,y=as.numeric(as.character(decompk)),colour=LumpedTrans))+
  ...
  scale_color_manual(values=c("violetred4","cornsilk4","darkblue"))+
  ylab("Decay rate (k)")+
  scale_y_continuous(limits=c(-6.5,0))
...
decompk.row.botup$Species=factor(decompk.row.botup$Species, levels=c("ACESAC","CAROVA","QUERUB"))
#Plot.
...
ggplot(decompk.row.botup, aes(x=Species,y=as.numeric(as.character(decompk)),colour=LumpedTrans))+
  ...
  scale_color_manual(values=c("seagreen4","cornsilk4","darkblue"))+
  ylab("Decay k")+
  scale_y_continuous(limits=c(-6.5,0))
...
decompk.row.ripbot$Species=factor(decompk.row.ripbot$Species, levels=c("ACESAC","CAROVA","QUERUB"))
#Plot
...
ggplot(decompk.row.ripbot, aes(x=Species,y=as.numeric(as.character(decompk)),colour=LumpedTrans))+
  ...
  ylab("Decay k")+
  scale_color_manual(values=c("violetred4","cornsilk4","seagreen4"))+
  scale_y_continuous(limits=c(-6.5,0))
...
decompk.enzyme.dopa=decompk.enzyme.dopa[decompk.enzyme.dopa$activity.lg!="Inf",]
#anova(decomp k~enzyme type)
decompk.aov.kdopa = aov(as.numeric(as.character(decompk.enzyme.dopa[,3]))~decompk.enzyme.dopa$Enzyme)
anova(decompk.aov.kdopa)
#lm(decomp~enzyme activity)
decompk.stat.dopa=lm(as.numeric(as.character(decompk.enzyme.dopa[,3]))~decompk.enzyme.dopa$activity.lg)
anova(decompk.stat.dopa)

##Hydrolase enzymes - merge
decompk.enzyme.hydro=merge(decompk.allspec.col,hydroact.dat, by="Plot")
decompk.enzyme.hydro=decompk.enzyme.hydro[decompk.enzyme.hydro$activity.lg!="Inf",]
#anova(decomp k ~ Enzyme type)
decompk.aov.khydro = aov(as.numeric(as.character(decompk.enzyme.hydro[,3]))~decompk.enzyme.hydro$Enzyme)
anova(decompk.aov.khydro)
#lm(decomp~enzyme activity)
decompk.stat.hydro=lm(as.numeric(as.character(decompk.enzyme.hydro[,3]))~decompk.enzyme.hydro$activity.lg)
anova(decompk.stat.hydro)
```
...
####phos graph####
##Riparian Upland
ggplot(phos.ripup, aes(x=Species,y=activity.lg,colour=Harvest))+
  geom_boxplot(position=position_dodge(0.9), size=1)+
  #ggtitle("Riparian-Bottomland")  +
  theme_bw()+
  theme(panel.grid.major = element_blank(), 
...
##Bottomland Upland
ggplot(phos.botup, aes(x=Species,y=activity.lg,colour=Harvest))+
  geom_boxplot(position=position_dodge(0.9), size=1)+
  #ggtitle("Riparian-Bottomland")  +
  theme_bw()+
  theme(panel.grid.major = element_blank(), 
...
##Riparian Bottomland
##Bottomland Upland
ggplot(phos.ripbot, aes(x=Species,y=activity.lg,colour=Harvest))+
  geom_boxplot(position=position_dodge(0.9), size=1)+
  #ggtitle("Riparian-Bottomland")  +
  theme_bw()+
  theme(panel.grid.major = element_blank(), 
...
####dopa graph####
##Riparian Upland
ggplot(dopa.ripup, aes(x=Species,y=activity.lg,colour=LumpTrans))+
  geom_boxplot(position=position_dodge(0.9), size=1)+
  #ggtitle("Riparian-Bottomland")  +
  theme_bw()+
  theme(panel.grid.major = element_blank(), 
...
####h2o2 graph####
##Riparian Upland
ggplot(h2o2.ripup, aes(x=Species,y=activity.lg,colour=LumpTrans))+
  geom_boxplot(position=position_dodge(0.9), size=1)+
  #ggtitle("Riparian-Bottomland")  +
  theme_bw()+
  theme(panel.grid.major = element_blank(), 
...
##Bottomland Upland
h2o2.botup$LumpTrans=factor(h2o2.botup$LumpTrans, levels=c("B","UB","U"))
ggplot(h2o2.botup, aes(x=Species,y=activity.lg,colour=LumpTrans))+
  geom_boxplot(position=position_dodge(0.9), size=1)+
  #ggtitle("Riparian-Bottomland")  +
  theme_bw()+
  theme(panel.grid.major = element_blank(), 
...
##Riparian Bottomland
h2o2.ripbot$LumpTrans=factor(h2o2.ripbot$LumpTrans, levels=c("R","RB","B"))
ggplot(h2o2.ripbot, aes(x=Species,y=activity.lg,colour=LumpTrans))+
  geom_boxplot(position=position_dodge(0.9), size=1)+
  theme_bw()+
  theme(panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
...
dopa.rda.fulsoil = rda(as.numeric(as.character(dopaact.dat.eco[,53])), dopaact.dat.eco[,21:45])
...
dopa.rda.fulsoil = lm(dopaact.dat.eco[,53]~ dopaact.dat.eco[,8])
anova(dopa.rda.fulsoil)
RsquareAdj(dopa.rda.fulsoil)
global.thresh=RsquareAdj(dopa.rda.fulsoil)$adj.r.squared
...
##Core
dopaact.dat.eco=dopaact.dat.eco[dopaact.dat.eco$EP=="Core",]
#dopa enzymes ~ soil variables
#gotta remove some NAs in the soil variables to make this code work.
dopaact.dat.eco=na.exclude(dopaact.dat.eco)
dopa.rda.fulsoil = rda(dopaact.dat.eco[,53], dopaact.dat.eco[,21:45])
...
dopa.sel=ordiR2step(dopa.rda.fulsoil.none,scope=formula(dopa.rda.fulsoil.full),Pin=0.05,R2scope=TRUE)
dopa.sel
#Forward selection picks: pH_long, ps1_nug, moist_short

##Check for an ecosystem effect
dopa.rda.fulsoil = lm(dopaact.dat.eco[,53]~ dopaact.dat.eco[,2])
anova(dopa.rda.fulsoil)
summary(dopa.rda.fulsoil)
RsquareAdj(dopa.rda.fulsoil)
global.thresh=RsquareAdj(dopa.rda.fulsoil)$adj.r.squared


####Hydro enzymes####
hydroact.dat.eco=na.exclude(hydroact.dat.eco)
hydro.rda.fulsoil = rda(hydroact.dat.eco[,53], hydroact.dat.eco[,21:45])
anova(hydro.rda.fulsoil)
RsquareAdj(hydro.rda.fulsoil)
global.thresh=RsquareAdj(hydro.rda.fulsoil)$adj.r.squared

hydro.rda.fulsoil.none = rda(hydroact.dat.eco[,53]~1)
hydro.rda.fulsoil = rda(hydroact.dat.eco[,53], hydroact.dat.eco[,21:45])

hydro.rda.fulsoil.full=rda(hydroact.dat.eco[,53]~hydroact.dat.eco$Ptot_long+hydroact.dat.eco$Po_long+hydroact.dat.eco$pH_long+hydroact.dat.eco$moist_long+hydroact.dat.eco$ps1_long+hydroact.dat.eco$ps2_long+hydroact.dat.eco$percc_long+hydroact.dat.eco$cton_long+hydroact.dat.eco$Ptot_nug+hydroact.dat.eco$Po_nug+hydroact.dat.eco$pH_nug+hydroact.dat.eco$moist_nug+hydroact.dat.eco$ps1_nug+hydroact.dat.eco$ps2_nug+hydroact.dat.eco$percc_nug+hydroact.dat.eco$cton_nug+hydroact.dat.eco$Ptot_short+hydroact.dat.eco$Po_short+hydroact.dat.eco$pH_short+hydroact.dat.eco$moist_short +hydroact.dat.eco$ps1_short+hydroact.dat.eco$percc_short+hydroact.dat.eco$cton_short)
...
##Check for an ecosystem effect
hydro.rda.fulsoil = lm(hydroact.dat.eco[,53]~hydroact.dat.eco[,8])
anova(hydro.rda.fulsoil)
RsquareAdj(hydro.rda.fulsoil)
global.thresh=RsquareAdj(hydro.rda.fulsoil)$adj.r.squared
...
# Core+edge
hydroact.dat.eco=hydroact.dat.eco[hydroact.dat.eco$EP!="Trans",]
hydro.rda.fulsoil = rda(hydroact.dat.eco[,53], hydroact.dat.eco[,21:45])
anova(hydro.rda.fulsoil)
RsquareAdj(hydro.rda.fulsoil)
global.thresh=RsquareAdj(hydro.rda.fulsoil)$adj.r.squared
...
# Core
hydroact.dat.eco=hydroact.dat.eco[hydroact.dat.eco$EP=="Core",]
hydro.rda.fulsoil = rda(hydroact.dat.eco[,53], hydroact.dat.eco[,21:45])
anova(hydro.rda.fulsoil)
RsquareAdj(hydro.rda.fulsoil)
global.thresh=RsquareAdj(hydro.rda.fulsoil)$adj.r.squared
